...
export default function Header({ user }: Props) {
  ...
  return (
    <header
      ref={headerRef}
      className="header-container h-[64.8px] flex items-center border-b border-border-default transition-colors bg-canvas-default/80 backdrop-blur-md sticky top-0 z-[100]"
    >
            ...
            ? (
              <>
                <nav
                  ...
                  } flex-col sm:flex-row gap-3 items-start sm:items-center fixed sm:static left-0 right-0 w-full sm:w-auto bg-canvas-default sm:bg-transparent p-4 sm:p-0 border-b sm:border-b-0 border-border-subtle z-50`}
