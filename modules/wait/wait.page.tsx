                ...
                >
                  ...
                  <div class="flex space-x-6 items-center">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`transition-colors hover:scale-110 transform duration-200 w-6 h-6 flex items-center justify-center rounded-full border-2 
    ${
                        isDark
