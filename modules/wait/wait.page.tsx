...
export default function Wait() {
  ...
  const headings = [
    "Masih pake excel untuk inventaris?",
    "Inventaris bikin pusing?",
    "Inventaris susah dipakai?",
    "Inventaris harganya kemahalan?",
    "Inventaris ga cocok dg kebutuhan?",
    "Inventaris ga bisa diakses di mana aja?",
    "Inventaris ga bisa diakses kapan aja?",
    "Inventaris ga bisa diakses departemen lain?",
    "Inventaris ga bisa diakses perangkat lain?",
    "Inventaris ga nyambung dg purchasing?",
    "Inventaris ga nyambung dg accounting?",
    "Inventaris ga nyambung dg gudang?",
    "Inventaris ga nyambung dg supplier?",
    "Inventaris ga nyambung dg pelanggan?",
  ];
