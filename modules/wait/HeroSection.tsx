...
export default function HeroSection({ title, description }: HeroSectionProps) {
  // Moving stars background animation in the background of the hero section
  return (
    <div class="flex-1 min-w-0">
      <main
        class="bg-gray-800/70 rounded-lg shadow-md border border-gray-700 px-4 py-8 sm:py-24 sm:px-6 lg:px-8 text-center relative overflow-hidden backdrop-blur-lg group hover:border-blue-500/50 hover:shadow-xl hover:bg-blue-900/20 transition-all duration-200 transform group-hover:scale-[1.025]"
        style={{
          boxShadow:
