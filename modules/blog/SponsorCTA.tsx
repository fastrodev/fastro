export default function SponsorCTA() {
  return (
    <div class="bg-white/80 backdrop-blur-sm border border-stone-300/50 shadow-sm hover:shadow-md hover:bg-white/90 transition-all duration-200 rounded-2xl p-4">
