            ...
            {submitted
              ? (
                <div className="text-center py-4">
                  ...
                  <h2 className="text-2xl font-bold text-fg-default mb-6">
                    Signed in
                  </h2>
                  <div className="bg-canvas-subtle rounded-2xl p-4 text-left border border-border-subtle">
                    <pre className="text-xs font-mono text-fg-muted overflow-auto max-h-40">
