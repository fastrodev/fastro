...
Fastro is a simple and fast web framework built on top of [deno](https://deno.land). Its speed is close to the raw deno http library speed is [close to the raw deno http library](docs/perfomance.md). Written in typescript. 
