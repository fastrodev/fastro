...
```tsx
import application, { h }  from "https://deno.land/x/fastro@v0.53.0/server/mod.ts";
...
```
deno run -A --config deno.json https://deno.land/x/fastro@v0.53.0/examples/html_response_jsx.tsx
```
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/html_response_native.ts
```

### HTML with Fastro Response

```ts
import application, { response } from "https://deno.land/x/fastro@v0.53.0/server/mod.ts";
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/html_response_fastro.ts
```
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/json_response_default.ts
```
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/json_response_native.ts
```
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/json_response_fastro.ts
```
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/cookies_native.ts
```
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/cookies_fastro.ts
```

### HTML Render with Eta Template Engine

```ts
import application from "https://deno.land/x/fastro@v0.53.0/server/mod.ts";import { render } from "https://deno.land/x/eta@1.12.3/mod.ts";
const app = application();
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/html_render.ts
```
...
```ts
import application, { getQueries, getQuery } from "https://deno.land/x/fastro@v0.53.0/server/mod.ts";
...
```
deno run -A https://deno.land/x/fastro@v0.53.0/examples/query_params.ts
```
...
```ts
import application, { dependency } from "https://deno.land/x/fastro@v0.53.0/server/mod.ts";
const app = application();
