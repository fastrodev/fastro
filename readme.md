...
```
deno run -A --unstable https://deno.land/x/fastro@v0.53.0/examples/response_ssr.tsx
```

[![alt text](https://raw.githubusercontent.com/fastrodev/fastro/gh-pages/assets/img/deno-deploy-button.svg)](https://dash.deno.com/new?url=https://deno.land/x/fastro@v0.53.0/examples/response_ssr.tsx)
