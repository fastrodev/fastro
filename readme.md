...
Fastro is a simple and fast web framework built on top of [deno](https://deno.land). Easy to use and the speed is [close to the raw deno http library](docs/perfomance.md). Written in typescript. 
