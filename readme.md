...
Fastro is simple and fast web framework. Built on top of [deno standard library](https://deno.land/std@0.74.0).
...
The speed is close to the raw deno HTTP library. [Check perfomance test](docs/perfomance.md).
