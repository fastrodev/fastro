...
Fastro is a simple and fast web framework built on top of [deno](https://deno.land). The speed is [close to the raw deno http library](docs/perfomance.md). Written in typescript. 
