...
**File system routing**: no need to register routes, controllers, middlewares, templates, or static
files. They will be loaded and saved when the server starts.

**React SSR**: go to [react ssr](https://fastro.dev/docs/react.html) to create react
